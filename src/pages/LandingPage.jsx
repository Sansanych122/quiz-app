...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] text-slate-900 font-sans relative overflow-hidden flex flex-col selection:bg-blue-100">
      ...
      <header className="w-full max-w-6xl mx-auto px-6 py-8 relative z-10 flex justify-between items-center">
        <button 
      ...
      {/* ОСНОВНИЙ КОНТЕНТ */}
      <main className="flex-grow w-full max-w-6xl mx-auto px-6 relative z-10 flex flex-col pt-16 md:pt-24">
        ...
        <section className="text-center max-w-4xl mx-auto mb-32 custom-animate-fade-in">
          ...
          <p className="text-lg sm:text-xl text-slate-500 font-medium leading-relaxed mb-12 max-w-2xl mx-auto">
            UniQuiz перетворює твої лекції та конспекти на інтерактивні тести за допомогою AI. Запам'ятовуй матеріал швидше, відстежуй прогрес та складай іспити на відмінно.
          </p>
        ...
        {/* ФУНКЦІОНАЛ — Глибокі тіні (Glassmorphism) та ефект підняття */}
        <section className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-32">
          
          <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500">
            <h2 className="text-2xl font-black text-slate-900 mb-4">AI Генерація тестів</h2>
            <p className="text-slate-500 font-medium leading-relaxed text-base">
              Забудь про рутинне складання карток. Завантаж PDF або DOCX документ, і наш штучний інтелект автоматично витягне головне та створить готовий модуль тестів за секунди.
            </p>
          </div>

          <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Робота над помилками</h2>
            <p className="text-slate-500 font-medium leading-relaxed text-base">
              Алгоритм запам'ятовує твої слабкі місця. Переходь у режим помилок, щоб сфокусуватись лише на тих питаннях, які викликали труднощі, доки не засвоїш їх на 100%.
            </p>
          </div>

          <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Динамічне перемішування</h2>
            <p className="text-slate-500 font-medium leading-relaxed text-base">
              Уникай механічного звикання. При кожному новому проходженні система перемішує як самі питання, так і варіанти відповідей, змушуючи твій мозок справді аналізувати.
            </p>
          </div>

          <div className="bg-white/40 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-500">
            <h2 className="text-2xl font-black text-slate-900 mb-4">Глобальний Leaderboard</h2>
            <p className="text-slate-500 font-medium leading-relaxed text-base">
              Навчання — це теж змагання. Відстежуй свою загальну успішність, змагайся з друзями та іншими студентами за першість у глобальному рейтингу платформи.
            </p>
          </div>
        ...
        <section className="mb-32 py-20 border-y border-slate-100 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-6 tracking-tight">Вже понад 1000 тестів пройдено сьогодні</h2>
